...
export default function SecuritySettings() {
 return (
  <div className="space-y-2">
   ...
   <div className="border border-[#EDEEF2] max-md:py-6 max-md:px-4 md:p-0 rounded-[16px]">
    ...
    {/* Change Password */}
    <section className="bg-neutral-white rounded-[16px] pt-[48px] md:px-[16px] md:py-[24px] sm:p-8 shadow-sm">
     <h2 className="text-lg md:font-semibold font-[700] md:mb-6 mb-4 text-foreground">
      Change password
     </h2>
    ...
    {/* Action Buttons */}
    <div className="gap-4 py-5 md:px-4 mt-3">
