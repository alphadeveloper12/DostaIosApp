...
const PortfolioContent = () => {
 ...
 const categories = ["All", "Catering", "Delivery", "Events"];
 ...
 const projects = [
  {
   ...
   description:
    "Exquisite catering for a 500-person corporate event with a custom menu.",
  },
  {
   id: 2,
   title: "City-Wide Logistics",
   category: "Delivery",
   image:
    "https://images.unsplash.com/photo-1586864387967-d02ef85d93e8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
   description:
    "Optimized delivery network implementation for a major retail chain.",
  },
  {
   id: 3,
   title: "Wedding Feast",
   ...
   description:
    "A magical wedding reception featuring a multi-course gourmet experience.",
  },
  {
   id: 4,
   title: "Tech Conference Lunch",
   category: "Catering",
   image:
    "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
   description:
    "Healthy and energizing lunch boxes for 2000+ conference attendees.",
  },
  {
   id: 5,
   ...
   category: "Delivery",
   image:
    "https://images.unsplash.com/photo-1616401784845-180882ba9ba8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
   description:
    "Innovative last-mile delivery solution reducing wait times by 40%.",
  },
  {
   id: 6,
   ...
   description:
    "Full-service event management and catering for a high-profile fundraiser.",
  },
 ];
