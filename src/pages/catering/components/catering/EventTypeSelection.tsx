...
interface EventTypeSelectionProps {
  ...
  setSelectedEvent: React.Dispatch<React.SetStateAction<{ id: string | null; name: string | null }>>;
  guestCount: number;
...
const EventTypeSelection: React.FC<EventTypeSelectionProps> = ({
  ...
  const [eventTypes, setEventTypes] = useState<{ id: number; name: string; image_url: string }[]>([]);
          ...
          {selectedDateTime ? (
            <div>
              ...
              <div className="flex items-center gap-4">
                <span style={{ fontSize: "16px", color: "#2B2B43", fontWeight: 400 }}>{selectedDateTime}</span>
                <button
