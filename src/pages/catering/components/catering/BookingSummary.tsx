...
const BookingSummary: React.FC<BookingSummaryProps> = ({
  ...
  const calculateTotal = () => {
    const basePricePerGuest = selectedBudget.price_range ? parseFloat(selectedBudget.price_range.replace('AED', '').trim()) : 70;
  ...
  console.log("Booking Summary Data: ", JSON.stringify({
    eventType,
    guestCount,
    selectedDateTime,
    selectedProvider,
          ...
          <div className="lg:w-2/3">
            <div className="bg-neutral-white rounded-lg shadow-sm" style={{ border: "1px solid #EDEEF2", borderRadius: "16px", padding: "20px 24px" }}>
              ...
              <div className="mb-6 pb-6">
                ...
                <p className="mb-1" style={{ fontSize: '16px', fontWeight: '700', color: '#056AC1' }}>
              ...
              <div className="mb-6 pb-6">
                ...
                <p className="text-blue-600 font-medium">
                  {selectedServiceStyles.length > 0 ? selectedServiceStyles.join(", ") : "Not Selected"}
                </p>
              </div>
              ...
              <div className="mb-6 pb-6">
                ...
                <p className="text-blue-600 font-medium">
                  {selectedCuisines.length > 0 ? selectedCuisines.map(cuisine => cuisine.name).join(", ") : "Not Selected"}
                </p>
              </div>
              ...
              <div className="mb-6 pb-6">
                ...
                <p className="text-blue-600 font-medium">
                  {selectedCourses.length > 0 ? selectedCourses.map(course => course.name).join(", ") : "Not Selected"}
                </p>
              </div>
